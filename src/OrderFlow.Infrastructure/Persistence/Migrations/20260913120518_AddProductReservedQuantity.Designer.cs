...
namespace OrderFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913120518_AddProductReservedQuantity")]
    partial class AddProductReservedQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderFlow.Domain.Entities.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_orders_status", "[status] COLLATE Latin1_General_CS_AS IN (N'PendingPayment', N'Paid', N'Confirmed', N'Cancelled')");
