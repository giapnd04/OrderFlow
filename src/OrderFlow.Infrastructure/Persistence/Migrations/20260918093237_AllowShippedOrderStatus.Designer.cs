...
namespace OrderFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918093237_AllowShippedOrderStatus")]
    partial class AllowShippedOrderStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderFlow.Domain.Entities.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_orders_status", "[status] COLLATE Latin1_General_CS_AS IN (N'PendingPayment', N'Paid', N'Confirmed', N'Cancelled', N'Shipped')");
