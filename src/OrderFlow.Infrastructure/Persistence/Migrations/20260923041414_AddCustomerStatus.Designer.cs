...
namespace OrderFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923041414_AddCustomerStatus")]
            ...
            modelBuilder.Entity("OrderFlow.Domain.Entities.Customer", b =>
                {
                    ...
                    b.ToTable("customers", null, t =>
                        {
                            t.HasCheckConstraint("ck_customers_status", "[status] COLLATE Latin1_General_CS_AS IN (N'Active', N'Inactive')");
                        });
                });
            ...
            modelBuilder.Entity("OrderFlow.Domain.Entities.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_orders_status", "[status] COLLATE Latin1_General_CS_AS IN (N'PendingPayment', N'Paid', N'Confirmed', N'Cancelled', N'Shipped', N'Delivered')");
